...
function Payment() {
  ...
  async function displayRazorpay() {
    ...
    const result = await axios.post("http://localhost:3001/api/payment/orders", { amount: 72482 });
    if (!result) {
    ...
    <>
      ...
      <div className="flex justify-center items-start gap-5 p-2 mb-70">
        ...
        <div className="bg-white w-150 rounded-2xl shadow-2xl p-2">
          ...
          <h2 className="flex items-center gap-3 font-semibold p-2"><AiTwotoneDatabase size={25} /> Basic Plan</h2>
        ...
        <div className="bg-white p-2 rounded-2xl shadow-2xl w-90">
          ...
          <h2 className="font-bold p-2">Basic Plan</h2>
          ...
          <div className="p-2">
            ...
            <div className="flex justify-between mt-4 mb-4">
              ...
              <div>
                ...
                <span className="font-bold ml-2">₹724.82</span>
              </div>
            </div>
