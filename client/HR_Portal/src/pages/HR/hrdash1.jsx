          ...
          <section id="dashboard">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <h1 className="text-4xl font-bold text-green-600 mt-3">0</h1>
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <h1 className="text-4xl font-bold text-yellow-500 mt-3">0</h1>
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <h1 className="text-4xl font-bold text-red-500 mt-3">0</h1>
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <h1 className="text-4xl font-bold text-blue-600 mt-3">0</h1>
